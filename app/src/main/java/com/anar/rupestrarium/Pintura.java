...
public class Pintura extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String mtitle = getString(R.string.pint);
        title.setText(mtitle);
        icon.setImageResource(R.drawable.pintura_ico);

        TextView figura = (TextView) findViewById(R.id.figura);
        figura.setText(R.string.zoomorfa);
        Button refresh = (Button) findViewById(R.id.refresh);
        refresh.performClick();
        refresh.callOnClick();

        final Integer[] superior_adapter = {R.drawable.cabeza_animal, R.drawable.cabeza_antro,
                R.drawable.cabeza_geo};
        final Integer[] medio_adapter = {R.drawable.cuerpo_animal, R.drawable.cuerpo_antro,
                R.drawable.cuerpo_geo};
        final Integer[] inferior_adapter =  {R.drawable.inferior_animal, R.drawable.inferior_antro,
                R.drawable.inferior_geo};

        final Gallery superior = (Gallery) findViewById(R.id.superior);
        Gallery medio = (Gallery) findViewById(R.id.medio);
        Gallery inferior = (Gallery) findViewById(R.id.inferior);

        final GalleryAdapter sup = new GalleryAdapter(this,superior_adapter,0);
    ...
    public void first_click(View v){
        ...
        final TextView figura = (TextView) findViewById(R.id.figura);
        first.setVisibility(View.GONE);
        figura.setText(getString(R.string.zoomorfa));
        TextView desc = (TextView)findViewById(R.id.descripint);
        desc.setText(def);
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            startActivity(new Intent(Pintura.this, MainActivity.class)
    ...
    public class GalleryAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final TextView desc = (TextView)findViewById(R.id.descripint);
            if (i != a || j != b || k !=c ) {
                desc.setVisibility(View.INVISIBLE);
            }
