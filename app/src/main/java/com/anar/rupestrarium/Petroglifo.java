...
public class Petroglifo extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_petroglifo);
        ...
        String mtitle = getString(R.string.petro);
        title.setText(mtitle);
        icon.setImageResource(R.drawable.petroglifo_ico);

        TextView figura = (TextView) findViewById(R.id.figura_petro);
        figura.setText(R.string.zoomorfa);
        Button refresh = (Button) findViewById(R.id.refresh);
        refresh.performClick();
        refresh.callOnClick();

        final Integer[] superior_adapter = {R.drawable.cabeza_animal_petro, R.drawable.cabeza_antro_petro,
                R.drawable.cabeza_geo_petro};
        final Integer[] medio_adapter = {R.drawable.cuerpo_animal_petro, R.drawable.cuerpo_antro_petro,
                R.drawable.cuerpo_geo_petro};
        final Integer[] inferior_adapter =  {R.drawable.inferior_animal_petro, R.drawable.inferior_antro_petro,
                R.drawable.inferior_geo_petro};

        Gallery superior = (Gallery) findViewById(R.id.superior_petro);
        Gallery medio = (Gallery) findViewById(R.id.medio_petro);
        Gallery inferior = (Gallery) findViewById(R.id.inferior_petro);
    ...
    public void first_click(View v){
        ...
        final TextView figura = (TextView) findViewById(R.id.figura_petro);
        first.setVisibility(View.GONE);
        figura.setText(getString(R.string.zoomorfa));
        TextView desc = (TextView)findViewById(R.id.descripetro);
        desc.setText(def);
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            startActivity(new Intent(Petroglifo.this, MainActivity.class)
    ...
    public class GalleryAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final TextView desc = (TextView)findViewById(R.id.descripetro);
            if (i != a || j != b || k !=c ) {
                desc.setVisibility(View.INVISIBLE);
            }
