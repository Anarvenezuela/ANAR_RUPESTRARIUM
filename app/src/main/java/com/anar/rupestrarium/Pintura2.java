...
public class Pintura2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pintura2);
        ...
        String mtitle = getString(R.string.pint2);
        ...
        final Integer[] superior_adapter = {R.drawable.cabeza_animal2, R.drawable.cabeza_antro2,
                R.drawable.cabeza_geo2};
        final Integer[] medio_adapter = {R.drawable.cuerpo_animal2, R.drawable.cuerpo_antro2,
                R.drawable.cuerpo_geo2};
        final Integer[] inferior_adapter =  {R.drawable.inferior_animal2, R.drawable.inferior_antro2,
                R.drawable.inferior_geo2};

        Gallery superior = (Gallery) findViewById(R.id.superior2);
        Gallery medio = (Gallery) findViewById(R.id.medio2);
        Gallery inferior = (Gallery) findViewById(R.id.inferior2);
    ...
    public void first_click(View v){
        ...
        figura.setText(getString(R.string.zoomorfa));
        TextView desc = (TextView)findViewById(R.id.descripint2);
        desc.setText(def);
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            startActivity(new Intent(Pintura2.this, MainActivity.class)
    ...
    public class GalleryAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final TextView desc = (TextView)findViewById(R.id.descripint2);
            if (i != a || j != b || k !=c ) {
                desc.setVisibility(View.INVISIBLE);
            }
